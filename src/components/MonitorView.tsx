...
function getPreviewBaseUrl(streamUrl: string): string | null {
  ...
  try {
    ...
    if (protocol === "srt:") {
      ...
      return `http://${parsed.hostname}:${previewPort}/api/frame.jpeg?src=240p`;
    }
    if (protocol === "rtsp:") {
      ...
      return `http://${parsed.hostname}:${previewPort}/api/frame.jpeg?src=240p_o`;
    }
    return null;
  } catch {
    return null;
...
function getWebrtcBaseUrl(streamUrl: string): string | null {
  ...
  try {
    ...
    if (protocol === "rtsp:") {
      ...
      return `http://${parsed.hostname}:${webrtcPort}/stream.html?src=240p_o`;
    }
    return null;
  } catch {
    return null;
